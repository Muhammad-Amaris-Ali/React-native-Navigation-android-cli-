    ...
    <View style={styles.main_dome}>
      <View style={styles.div_1}>
        <TouchableOpacity onPress={() => navigation.openDrawer()}>
          <Text style={styles.topictop}>Wallet</Text></TouchableOpacity>
      ...
      <View style={styles.div_2}>
        <ImageBackground source={image4} resizeMode="cover" style={styles.imageback2} imageStyle={{ borderRadius: 20 }}>
